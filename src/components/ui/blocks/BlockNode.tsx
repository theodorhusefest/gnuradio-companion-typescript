...
const BlockNode = ({ data, id }: NodeProps<GraphNode>) => {
  ...
  const allParameters = buildParametersWithValues(blockDefinition.parameters, currentParameters)
  ...
  const handleParametersUpdate = (updates: Record<string, string | number | boolean>) => {
    takeSnapshot()
    updateNode(id, {
      parameters: {
        ...currentParameters,
