...
function ___syscall_getdents64(fd, dirp, count) {
  if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(5, 0, 1, fd, dirp, count);
  try {
    var stream = SYSCALLS.getStreamFromFD(fd);
...
var proxiedFunctionTable = [ _proc_exit, exitOnMainThread, pthreadCreateProxied, ___syscall_fcntl64, ___syscall_fstat64, ___syscall_getdents64, ___syscall_ioctl, ___syscall_lstat64, ___syscall_mkdirat, ___syscall_newfstatat, ___syscall_openat, ___syscall_stat64, _environ_get, _environ_sizes_get, _fd_close, _fd_read, _fd_seek, _fd_write ];
...
var ASM_CONSTS = {
  8126576: () => PThread ? PThread.unusedWorkers.length : -1,
  8126632: () => (typeof process !== "undefined" && typeof process.versions === "object" && !!process.versions.node) ? 1 : 0,
  8126752: () => (typeof window !== "undefined" && typeof window.document !== "undefined") ? 1 : 0,
  8126846: () => (typeof globalThis.fetch === "function") ? 1 : 0,
  8126907: ($0, $1, $2) => {
    const filename = UTF8ToString($0);
    const ptr = $1 >>> 0;
    const len = $2 >>> 0;
    const array = new Uint8Array(len);
    array.set((growMemViews(), HEAPU8).subarray(ptr, ptr + len));
  ...
  8127615: () => (typeof globalThis.fetch === "function") ? 1 : 0
};
...
var _fileio_dialog_on_bytes = Module["_fileio_dialog_on_bytes"] = makeInvalidEarlyAccess("_fileio_dialog_on_bytes");

var _fileio_dialog_on_cancel = Module["_fileio_dialog_on_cancel"] = makeInvalidEarlyAccess("_fileio_dialog_on_cancel");

var _fileio_dialog_on_error = Module["_fileio_dialog_on_error"] = makeInvalidEarlyAccess("_fileio_dialog_on_error");
...
function assignWasmExports(wasmExports) {
  ...
  assert(typeof wasmExports["fileio_dialog_on_bytes"] != "undefined", "missing Wasm export: fileio_dialog_on_bytes");
  assert(typeof wasmExports["fileio_dialog_on_cancel"] != "undefined", "missing Wasm export: fileio_dialog_on_cancel");
  assert(typeof wasmExports["fileio_dialog_on_error"] != "undefined", "missing Wasm export: fileio_dialog_on_error");
  ...
  _fileio_dialog_on_bytes = Module["_fileio_dialog_on_bytes"] = createExportWrapper("fileio_dialog_on_bytes", 3);
  _fileio_dialog_on_cancel = Module["_fileio_dialog_on_cancel"] = createExportWrapper("fileio_dialog_on_cancel", 1);
  _fileio_dialog_on_error = Module["_fileio_dialog_on_error"] = createExportWrapper("fileio_dialog_on_error", 1);
